    ...
    return (
        <Scrollbar
            ...
            <Container maxWidth="md" sx={{ position: 'sticky', left: 0, bottom: 0, zIndex: 99 }}>
                ...
                <Card elevation={0} sx={{ borderRadius: borderRadius, boxShadow: `0px -16px 16px 0px ${muiTheme.palette.background}, 0px 0px 0px 0px rgb(0 0 0 / 0%), 0px 0px 0px 0px rgb(0 0 0 / 0%)` }}>
                    <CardContent sx={{
                        display: 'flex',
